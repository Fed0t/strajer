...
Catalogul schema `3` si protocolul de sesiune `5` includ host-ul virtual,
chatul, countdown-ul, load sync si data-plane-ul binar de gameplay. Deploy-ul
serverului si build-urile noi de client trebuie coordonate; clientii cu protocol
`4` sau mai vechi sunt refuzati intentionat de serverul nou.
